...
parser.add_argument('--games', type=str, default="Gravitar", help='name of the games. for example: Breakout')
parser.add_argument('--seed', type=int, default=5, help='seed of the games')
...
dqn = DQN()
logdir = './DQN_epsilon/%s' % args.games + '/%i' % int(time.time())
